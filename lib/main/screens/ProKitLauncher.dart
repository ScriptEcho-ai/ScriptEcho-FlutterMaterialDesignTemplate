...
class ProKitLauncherState extends State<ProKitLauncher> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    future = getAllAppsAndThemes(route: widget.route);
    afterBuildCreated(() {
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      category(appCat6, app_ic_phone, snapshot.data!.workingApps!.name, isNew: true, type: snapshot.data!.workingApps!.tag, onTap: () {
                                        ProKitScreenListing(snapshot.data!.workingApps).launch(context);
                                      }),
