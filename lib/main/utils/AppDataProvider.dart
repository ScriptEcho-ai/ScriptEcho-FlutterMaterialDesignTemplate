...
import 'package:prokit_flutter/widgets/materialWidgets/mwDialogAlertPanelWidgets/MWExpansionPannelWidgets/MWExpansionPanelScreen3.dart';
...
import '../../themes/theme15/screens/T15dashbord_screen.dart';
import '../../themes/theme15/screens/T15donate_screen.dart';
import '../../themes/theme15/screens/T15drawer_screen.dart';
import '../../themes/theme15/screens/T15filter_screen.dart';
import '../../themes/theme15/screens/T15forgot_password_screen.dart';
import '../../themes/theme15/screens/T15payment_screen.dart';
import '../../themes/theme15/screens/T15pets_screen.dart';
import '../../themes/theme15/screens/T15search_screen.dart';
import '../../themes/theme15/screens/T15sign_in_screen.dart';
import '../../themes/theme15/screens/T15sign_up_screen.dart';
import '../../themes/theme15/screens/T15splash_screen.dart';
import '../../themes/theme15/screens/T15walkthrough_screen.dart';
import '../../widgets/materialWidgets/mwDialogAlertPanelWidgets/MWExpansionPannelWidgets/MWExpansionPanelScreen6.dart';
...
Future<AppTheme> getAllAppsAndThemes({String? route}) async {
  ...
  appTheme.integrations = getIntegrations(route: route);
  appTheme.webApps = getWebApps();
  appTheme.workingApps = getWorkingApps();

  if (route != null) {
    if (route.validate() == ProKitLauncher.integrationTag) {
      push(ProKitScreenListing(appTheme.integrations));
    } else if (route.validate() == ProKitLauncher.fullAppsTag) {
      push(ProKitScreenListing(appTheme.fullApp));
    } else if (route.validate() == ProKitLauncher.widgetsTag) {
      push(ProKitScreenListing(appTheme.widgets));
    } else if (route.validate() == ProKitLauncher.dashboardTag) {
      push(ProKitScreenListing(appTheme.dashboard));
    } else if (route.validate() == ProKitLauncher.workingAppsTag) {
      push(ProKitScreenListing(appTheme.workingApps));
    }
  }
  return appTheme;
}
...
List<ProTheme> getThemes() {
  List<ProTheme> list = [];
  list.add(ProTheme(name: 'Pet Adoption', title_name: 'Theme 15 Screens', tag: '', show_cover: true, sub_kits: getPetAdoptionKit(), darkThemeSupported: true));
...
List<ProTheme> getPetAdoptionKit() {
  List<ProTheme> list = [];

  list.add(ProTheme(name: 'Splash Screen', is_theme: true, type: '', widget: T15SplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Walkthrough Screen', is_theme: true, type: '', widget: Walkthrough(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Sign Up Screen', is_theme: true, type: '', widget: T15SignUpScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Sign In Screen', is_theme: true, type: '', widget: SignInScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Search Screen', is_theme: true, type: '', widget: SearchScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Pets Screen', is_theme: true, type: '', widget: PetsScreen(), darkThemeSupported: true));
  ...
  list.add(ProTheme(name: 'Dashboard', is_theme: true, type: '', widget: DashboardScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Card Screen', is_theme: true, type: '', widget: T15CardScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'BottomSheet Screen', is_theme: true, type: '', widget: BottomSheetScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Bottom Navigation Bar', is_theme: true, type: '', widget: BottomNavigationScreen(), darkThemeSupported: true));
...
ProTheme getDashboards() {
  ProTheme theme = ProTheme(sub_kits: [], name: 'Dashboards', title_name: 'Dashboard Screens', show_cover: true, tag: '');
  List<ProTheme> list = [];
  list.add(ProTheme(name: 'Banking Dashboard', tag: '', widget: BankingDashboard(), darkThemeSupported: true));
...
List<ProTheme> getExpansionPanelList() {
  ...
  list.add(ProTheme(name: 'Expansion Panel 3', show_cover: false, tag: '', type: '', widget: MWExpansionPanelScreen3(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'Expansion Panel 4', show_cover: false, tag: '', type: '', widget: MWExpansionPanelScreen4(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'Expansion Panel 5', show_cover: false, tag: '', type: '', widget: MWExpansionPanelScreen5(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'Expansion Panel 6', show_cover: false, tag: '', type: '', widget: MWExpansionPanelScreen6(), darkThemeSupported: true, isWebSupported: true));
...
ProTheme getWorkingApps() {
  ProTheme theme = ProTheme(name: "Working Modules", tag: 'New', show_cover: true, sub_kits: []);

  List<ProTheme> list = [];

  list.add(ProTheme(name: 'ChatGPT', widget: ChattingScreen(), tag: 'New', darkThemeSupported: true));
  list.add(ProTheme(name: 'Smart Email Generator', widget: ChatGPTSplashScreen(), tag: 'New', darkThemeSupported: true));
...
//region Interactions
ProTheme getIntegrations({String? route}) {
  List<ProTheme> list = [];
