...
//Google Sign In
const isGoogleSignedInOnPref = 'isGoogleSignedIn';
...
const AppstoreUrl='https://apps.apple.com/in/app/prokit-flutter/id1535323451';

const bannerAdIdForAndroidRelease = "ca-app-pub-13993275454544318575/5026584528";
const bannerAdIdForAndroid = "ca-app-pub-3940256099515142544/6300978111";
const bannerAdIdForIosRelease = "ca-app-pub-84660127515435057920/2958211618";
const bannerAdIdForIos = "ca-app-pub-3940256099954542544/2934735716";
const InterstitialAdIdForAndroidRelease = "ca-app-pub-139932755444318575/8774597158";
const InterstitialAdIdForAndroid = "ca-app-pub-39402560995154942544/1033173712";
const interstitialAdIdForIosRelease = "ca-app-pub-8466265012735057920/1453558254";
const interstitialAdIdForIos = "ca-app-pub-394025609259942544/4411468910";
...
//stripe
const stripePaymentKey = 'sk_test_51GrhA2Bz1ljKAgF9FIJPLupBUCHFCOy5rS6ffLCnYHSu6Od0Qyx3TElGfvgfbxIu8BGRvq14fgidGOYyNkQPivZGnzWoVt004fCZxVdk';
const STRIPE_PAYMENT_PUBLISH_KEY = 'pk_test_51GrhA2Bz1ljKAgF98fI6WfB2YUn4CewOB0DNQC1pSeXssfpUc1LlUYs3odefu19oPF0ATcqa52FXTYmv6v0mkvPZb9BSD00SUpBj9tI';
const stripeURL = 'https://api.stripe.com/v1/payment_intents';

///FlutterWave
const flutterWavePublicKey = 'FLWPUBK_TEST-eb3edef083cdfgv54890a7e22dc7eec9e0daa5-X';
const flutterWaveSecretKey = 'FLWSECK_TEST-d2759023efcdv54e6198a853b8e2dd3beb55-X';
const flutterWaveEncryptionKey = 'FLWSECK_TEST8497ccdef542db86c';

///paystack
const payStackPublicKey = 'pk_test_c46ddf9def17e34152df54daa1b6e2eb940dedea41f0';

///CopyRight
const copyRightText = "Copyright 2023. Made with love by Iqonic Design.";
