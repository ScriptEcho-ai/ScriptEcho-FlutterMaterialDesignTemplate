...
Map<String, WidgetBuilder> routes() {
  return <String, WidgetBuilder>{
    ...
    ProKitLauncher.fullAppsTag: (context) =>
        ProKitLauncher(route: ProKitLauncher.fullAppsTag),
    ProKitLauncher.workingAppsTag: (context) =>
        ProKitLauncher(route: ProKitLauncher.workingAppsTag),
    ProKitLauncher.integrationTag: (context) =>
        ProKitLauncher(route: ProKitLauncher.integrationTag),
    ProKitLauncher.widgetsTag: (context) =>
        ProKitLauncher(route: ProKitLauncher.widgetsTag),
    ProKitLauncher.dashboardTag: (context) =>
        ProKitLauncher(route: ProKitLauncher.dashboardTag),
    ProKitLauncher.chartsTag: (context) =>
        ProKitLauncher(route: ProKitLauncher.chartsTag),
    ...
    GETMethodExampleScreen.tag: (context) =>
        GETMethodExampleScreen(isDirect: true),
    ...
    BeforeAfterImageScreen.tag: (context) =>
        BeforeAfterImageScreen(isDirect: true),
    ...
    FingerprintAuthentication.tag: (context) =>
        FingerprintAuthentication(isDirect: true),
    LocalNotificationScreen.tag: (context) =>
        LocalNotificationScreen(isDirect: true),
    CalenderHomePage.tag: (context) => CalenderHomePage(isDirect: true),
    LiquidPullToRefreshScreen.tag: (context) =>
        LiquidPullToRefreshScreen(isDirect: true),
    ...
    MWMaterialButtonScreen.tag: (context) =>
        MWMaterialButtonScreen(isDirect: true),
    MWFlatButtonScreen.tag: (context) => MWFlatButtonScreen(),
    MWFloatingActionButtonScreen.tag: (context) =>
        MWFloatingActionButtonScreen(),
    ...
    MWDatetimePickerScreen.tag: (context) =>
        MWDatetimePickerScreen(isDirect: true),
    ...
    MWExpansionPanelScreen5.tag: (context) =>
        MWExpansionPanelScreen5(isDirect: true),
    ...
    MWUserAccountDrawerHeaderScreen1.tag: (context) =>
        MWUserAccountDrawerHeaderScreen1(),
    MWUserAccountDrawerHeaderScreen2.tag: (context) =>
        MWUserAccountDrawerHeaderScreen2(),
    MWUserAccountDrawerHeaderScreen3.tag: (context) =>
        MWUserAccountDrawerHeaderScreen3(),
    MWUserAccountDrawerHeaderScreen4.tag: (context) =>
        MWUserAccountDrawerHeaderScreen4(),
    ...
    CWSlidingSegmentedControlScreen.tag: (context) =>
        CWSlidingSegmentedControlScreen(),
    ...
    OpenContainerTransformScreen.tag: (context) =>
        OpenContainerTransformScreen(),
    ...
    UtilityTrackerDashboard.tag: (context) =>
        UtilityTrackerDashboard(isDirect: true),
    HealthMedicalDashboard.tag: (context) =>
        HealthMedicalDashboard(isDirect: true),
    ...
    TemperatureWidgetScreen.tag: (context) =>
        TemperatureWidgetScreen(isDirect: true),
